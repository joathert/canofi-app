...
Note that a bug was indentified in the LAI python routines in September 2022 that could have caused the divergence between hemiphot.R and canofi LAI discussed above. See this [issue](https://github.com/joathert/canofi-app/issues/17#issue-1424290650).  
